...
.l-section-title-bnpqt51vvhao:first-child {
    margin-top: 0;
}
.l-field-bnpqt51vvhao {
    margin-bottom: 10px;
}
.l-field-row-bnpqt51vvhao,
.l-field-grid-bnpqt51vvhao {
    display: grid;
    grid-template-columns: 1fr 1fr;
    gap: 10px;
    margin-bottom: 10px;
}
.l-label-bnpqt51vvhao {
    display: block;
    font-size: 12px;
    font-weight: 500;
    margin-bottom: 4px;
}
.l-required-bnpqt51vvhao {
    color: var(--error-color);
}
.l-input-bnpqt51vvhao,
.l-select-bnpqt51vvhao,
.l-textarea-bnpqt51vvhao {
    width: 100%;
    height: 28px;
    padding: 4px 8px;
    font-size: 13px;
...
.l-input-bnpqt51vvhao:focus,
.l-select-bnpqt51vvhao:focus,
.l-textarea-bnpqt51vvhao:focus {
    border-color: var(--focus-color);
}
.l-input-bnpqt51vvhao:disabled,
.l-select-bnpqt51vvhao:disabled,
.l-textarea-bnpqt51vvhao:disabled {
    opacity: 0.5;
    cursor: not-allowed;
}
.l-input-bnpqt51vvhao:read-only {
    opacity: 0.7;
}
.l-field-bnpqt51vvhao.l-field-error-bnpqt51vvhao .l-input-bnpqt51vvhao,
.l-field-bnpqt51vvhao.l-field-error-bnpqt51vvhao .l-select-bnpqt51vvhao,
.l-field-bnpqt51vvhao.l-field-error-bnpqt51vvhao .l-textarea-bnpqt51vvhao {
    border-color: var(--error-color);
}
.l-select-bnpqt51vvhao {
    cursor: pointer;
...
.l-select-bnpqt51vvhao[multiple] {
    height: auto;
...
.l-radio-group-bnpqt51vvhao {
    display: flex;
    gap: 12px;
}
.l-radio-bnpqt51vvhao,
.l-checkbox-bnpqt51vvhao {
    display: inline-flex;
    align-items: center;
    cursor: pointer;
    font-size: 13px;
...
.l-radio-bnpqt51vvhao input,
.l-checkbox-bnpqt51vvhao input {
    margin: 0 6px 0 0;
    cursor: pointer;
}
.l-toggle-bnpqt51vvhao {
    display: inline-flex;
    align-items: center;
    cursor: pointer;
}
.l-toggle-bnpqt51vvhao input {
    display: none;
}
.l-toggle-slider-bnpqt51vvhao {
    position: relative;
    width: 36px;
    height: 18px;
    background-color: var(--border-color);
...
.l-toggle-slider-bnpqt51vvhao::before {
    content: "";
    position: absolute;
    width: 14px;
    height: 14px;
...
.l-toggle-bnpqt51vvhao input:checked + .l-toggle-slider-bnpqt51vvhao {
    background-color: var(--focus-color);
}
.l-toggle-bnpqt51vvhao input:checked + .l-toggle-slider-bnpqt51vvhao::before {
    transform: translateX(18px);
}
.l-toggle-label-bnpqt51vvhao {
    margin-left: 8px;
}
.l-file-bnpqt51vvhao {
    font-size: 13px;
...
.l-file-bnpqt51vvhao::file-selector-button {
    padding: 4px 10px;
    font-size: 13px;
    font-family: inherit;
    color: var(--text-primary);
...
.l-range-bnpqt51vvhao::-webkit-slider-thumb {
    width: 14px;
    height: 14px;
    background-color: var(--focus-color);
    border-radius: 50%;
...
.l-range-bnpqt51vvhao::-moz-range-thumb {
    width: 14px;
    height: 14px;
    background-color: var(--focus-color);
    border-radius: 50%;
...
.l-field-bnpqt51vvhao .l-help-bnpqt51vvhao {
    display: block;
}
.l-error-bnpqt51vvhao {
    font-size: 11px;
    color: var(--error-color);
    margin-top: 3px;
    display: none;
}
.l-field-bnpqt51vvhao.l-field-error-bnpqt51vvhao .l-error-bnpqt51vvhao {
    display: block;
}
.l-form-actions-bnpqt51vvhao {
    margin-top: 16px;
    padding-top: 16px;
    border-top: 1px solid var(--border-color);
    display: flex;
...
.l-btn-primary-bnpqt51vvhao {
    background-color: var(--focus-color);
    color: white;
    border-color: var(--focus-color);
}
.l-btn-secondary-bnpqt51vvhao {
    background-color: var(--bg-menu);
    color: var(--text-primary);
}    
</style>
...
<div class="l-tabs-container-nxn7obp41rtw">
    <div class="l-tabs-strip-nxn7obp41rtw">
        ...
        <button class="l-tab-nxn7obp41rtw" data-tab="Add members">
            Add members
        </button>
    ...
    <div class="l-tabs-content-nxn7obp41rtw">
                ...
                <div class="l-listing-header-z3aejvs2syr0">
                    ...
                    <div class="l-listing-actions-z3aejvs2syr0">
                        <button
                            ...
                            id="create_user_button-z3aejvs2syr0">
                            Create User
                        </button>
                        <button
                            class="l-btn-z3aejvs2syr0 l-btn-primary-z3aejvs2syr0"
                            ...
                            <?php if(!empty($members)): ?>
                                <?php foreach($members as $member): ?>
                                    <tr class="l-row-z3aejvs2syr0">
                                        ...
                                        <td><?= !empty($member['is_active']) ? 'Active' : 'Inactive' ?></td>
                                        <td><?= esc($member['joined_at']) ?></td>
        ...
        <div class="l-tab-pane-nxn7obp41rtw" data-pane="Add members">
            <form method="post" action="/admin/teams/members/<?= $team['id'] ?>/add" class="l-form-bnpqt51vvhao">
                <?= csrf_field() ?>
                <div class="l-section-title-bnpqt51vvhao">Member Select</div>
                <div class="l-field-bnpqt51vvhao">
                    <label class="l-label-bnpqt51vvhao"
                        >Member Name
                        <span class="l-required-bnpqt51vvhao">*</span></label
                    >
                    <div class="l-control-bnpqt51vvhao">
                        <select
                            class="l-select-bnpqt51vvhao"
                            name="user_id"
                            required
                        >
                    ...
                    <div class="l-help-bnpqt51vvhao">
                        Selete the team memeber that you want to add
                    </div>
                </div>

                <div class="l-form-actions-bnpqt51vvhao">
                    <button
                        type="submit"
                        class="l-btn-bnpqt51vvhao l-btn-primary-bnpqt51vvhao"
                    >
                        Submit
                    </button>
                </div>
