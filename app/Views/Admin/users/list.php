...
<div class="l-listing-ab5tjmurbovg">
    ...
    <div class="l-listing-header-ab5tjmurbovg">
        <div class="l-listing-title-ab5tjmurbovg">
            <h1>Users</h1>
            <span class="l-subtitle-ab5tjmurbovg">All users listing</span>
        </div>

        <div class="l-listing-actions-ab5tjmurbovg">
            <a href="/admin/users/create" class="l-btn-ab5tjmurbovg l-btn-primary-ab5tjmurbovg" id="create_user_button-ab5tjmurbovg">Create User</a>
        ...
        <table class="l-table-ab5tjmurbovg">
            <thead>
                <tr>
                    ...
                    <th class="l-th-sortable-ab5tjmurbovg">Email</th>
                    <th class="l-th-sortable-ab5tjmurbovg">Role</th>
                    <th class="l-th-sortable-ab5tjmurbovg">Active Status</th>
                    ...
                    <?php foreach ($users as $user): ?>
                        <tr class="l-row-ab5tjmurbovg">
                            ...
                            <td class="l-td-actions-ab5tjmurbovg">
                                <a href="<?= base_url('admin/users/view/' . $user['id']) ?>" class="l-btn-link-ab5tjmurbovg">
                                    View
                                </a>

                                <a href="<?= base_url('admin/users/edit/' . $user['id']) ?>" class="l-btn-link-ab5tjmurbovg">
                                    Edit
                                </a>
